...
public object CrashHandler {
     ...
     *
     * @param configure The report information which specifies what information should be included in the report. Defaults to a new instance of ReportInfo.
     *
     ...
     */
    public fun Application.setupCrashHandler(configure: ReportInfo.() -> Unit = {}) {
        Thread.setDefaultUncaughtExceptionHandler { _, throwable ->
            ...
            startCrashReportActivity(this, packageInfo, logfile, configure)
        }
    }
     ...
     */
    public fun startCrashReportActivity(
        context: Context,
        packageInfo: PackageInfo,
        logfilePath: String,
        configure: ReportInfo.() -> Unit = {}
    ) {
        val reportInfo = ReportInfo().apply(configure)
        startActivity(context, Intent(context, CrashHandlerActivity::class.java).apply {
            ...
            putExtra("reportUrl", reportInfo.reportUrl)
        }, null)
    }
     ...
     */
    public fun getVersionReport(packageInfo: PackageInfo, info: ReportInfo = ReportInfo()): String {
